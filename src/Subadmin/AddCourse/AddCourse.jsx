...
const AddCourse = () => {
    ...
    const handleFileUpload = (e) => {
        ...
        if (selectedFile) {
            ...
            axios.post(`${process.env.REACT_APP_BACKEND_API_URL}course/`, formData, {
                headers: {
    ...
    const handleDownloadTemplate = () =>{
        axios.get(`${process.env.REACT_APP_BACKEND_API_URL}download-csv/Course/`, {
            responseType: 'blob', 
        })
        .then(response => {
        ...
        <div className="wrapper">
            <div className="subadmin_container">
                <div className='subadmin_inner'>
                    <div className="subadmin_header">Add Course</div>
